...
from mp.HiGCN_models import HiGCN_old
from mp.HiGCN_gin import HiGCN
...
def main(args):
    ...
    if args.model.startswith('gin') or args.model in ['HiGCN','HiGCN_gin']:  # load graph dataset
    ...
    elif args.model == 'HiGCN_old':
        model = HiGCN_old(args.max_petal_dim, #max simplix dimension
                     num_features,  # num_input_features
                     10,    #K
                     args.emb_dim,  # hidden
                     num_classes,  # num_classes
