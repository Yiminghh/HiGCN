...
def get_parser():
    ...
    parser.add_argument('--petalType', type=str, choices=['simplex','ring'],
                        help='')
    parser.add_argument('--max_petal_dim', type=int,
                        help='单纯形的时候对应的是其阶数，如=3表示四面体；ring时表示圈的大小')
...
def mol_parse(args):
    ...
    args.start_seed = 0
    args.stop_seed = 9
    args.exp_name = 'cwn-zinc-small'
    args.dataset = 'ZINC'
    args.train_eval_period = 20
    args.epochs = 1000
    args.batch_size = 128
    args.drop_rate = 0.0
