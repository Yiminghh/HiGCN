...
python train_model.py --RPMAX 100 --net HiSCN --dataset squirrel --lr 0.3 --alpha 1.0 --weight_decay 0.0  --dprate 0.6 --dropout 0.6 --early_stopping 500

python train_model.py --RPMAX 100 --net HiSCN --dataset squirrel --lr 0.4 --alpha 0.2 --weight_decay 0.0  --dprate 0.5 --dropout 0.7 --early_stopping 400
