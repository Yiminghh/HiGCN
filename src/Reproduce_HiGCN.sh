...
python train_model.py --RPMAX 50 --net HiGCN --dataset film --lr 0.01 --alpha 0.5 --weight_decay 0.001 --dprate 0.8 --dropout 0.8 --early_stopping 500
...
python train_model.py --RPMAX 50 --net HiGCN --dataset texas --lr 0.1 --alpha 0.8 --weight_decay 0.0001 --dprate 0.6 --dropout 0.6 --early_stopping 500

python train_model.py --RPMAX 50 --net HiGCN --dataset wisconsin --lr 0.2 --alpha 0.7 --weight_decay 0.0001 --dprate 0.6 --dropout 0.6 --early_stopping 500
